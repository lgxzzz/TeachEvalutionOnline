...
public class CaluDialog extends Dialog implements View.OnClickListener{
    ...
    public CaluDialog(Context context, int layoutid, boolean isCancelable, boolean isBackCancelable) {
